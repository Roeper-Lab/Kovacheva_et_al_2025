...
files = dir ('in_vitro_Kv4_inactivation_example.mat');
GroupName = 'Kv4_inactivation';  % aktueller Name der Gruppe
[nCells,~] =size(files);
...
ProtV = [-120:10:-20]; % pulse protocol voltage: -15 mV, -20mV ....
...
for k=1:nCells
    ...
    for i=1:n_tr
        ...
        Itau_lim = pks-abs(delta * 1/exp(1)); % where current is 1/e
